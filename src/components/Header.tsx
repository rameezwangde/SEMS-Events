...
import { Menu, X, Zap, MessageCircle, Instagram, Facebook } from 'lucide-react';
      ...
      >
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
           <div className="flex items-center justify-center h-16 sm:h-20 relative">
            ...
            {/* Futuristic Mobile Menu Button - Positioned absolutely on the right */}
            <button
              className="lg:hidden absolute right-0 w-10 h-10 sm:w-12 sm:h-12 bg-white/10 backdrop-blur-sm border border-white/20 rounded-full flex items-center justify-center hover:bg-white/20 transition-all duration-300"
