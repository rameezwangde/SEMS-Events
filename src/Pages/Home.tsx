...
import { ArrowRight, Users, Calendar, Zap, Eye, Target, MapPin, Play, Volume2, VolumeX, Loader2 } from 'lucide-react';
...
const Home = () => {
  ...
  return (
    ...
    >
      <HeroNavigation active="HOME" />

      {/* Hero Section - Crafting Unforgettable Moments - Updated for mobile navigation */}
